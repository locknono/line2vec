!(function(t) {
    ...
    var i = {
      ...
      _handleSnapping: function(t) {
        ...
        if (r.distance < s) {
          ...
          (u.lat === l.lat && u.lng === l.lng) ||
            ((e._snapLatLng = n),
            i.fire("pm:snap", a),
            e._layer.fire("pm:snap", a));
        } else
          this._snapLatLng &&
            (this._unsnap(a),
            (i._snapped = !1),
            a.marker.fire("pm:unsnap", a),
            this._layer.fire("pm:unsnap", a));
        return !0;
      },
      _checkPrioritiySnapping: function(t) {
        var e,
          ...
          u = s < a ? i : r;
        return (
          (e = (s < a ? s : a) < this.options.snapDistance ? u : o),
          Object.assign({}, e)
        );
      },
      _createSnapList: function() {
        ...
        i.eachLayer(function(r) {
          if (
            ...
            e.push(r),
              i.off("pm:remove", t._handleSnapLayerRemoval, t),
              i.on("pm:remove", t._handleSnapLayerRemoval, t);
            var o = L.polyline([], { color: "red", pmIgnore: !0 });
            n.push(o);
          }
        }),
      ...
      _calcClosestLayer: function(t, e) {
        ...
        return (
          e.forEach(function(e, r) {
            ...
            n.debugIndicatorLines[r].setLatLngs([t, o.latlng]),
              (i.distance === undefined || o.distance < i.distance) &&
                ((i = o).layer = e);
          }),
          i
        );
      ...
      _calcLayerDistances: function(t, e) {
        ...
        return { latlng: Object.assign({}, c), segment: l, distance: h };
      },
  ...
  function(t, e, n) {
    "use strict";
    function i(t, e, n) {
      if (((n = n || {}), !d(n))) throw new Error("options is invalid");
      var i = n.bbox,
        r = n.id;
      if (t === undefined) throw new Error("geometry is required");
      if (e && e.constructor !== Object)
    ...
    function a(t, e) {
      if (((e = e || {}), !d(e))) throw new Error("options is invalid");
      var n = e.bbox,
        i = e.id;
    ...
    function u(t, e, n) {
      if (!t) throw new Error("coordinates is required");
      return i({ type: "MultiLineString", coordinates: t }, e, n);
    }
    function l(t, e, n) {
      if (!t) throw new Error("coordinates is required");
      return i({ type: "MultiPoint", coordinates: t }, e, n);
    }
    function h(t, e, n) {
      if (!t) throw new Error("coordinates is required");
      return i({ type: "MultiPolygon", coordinates: t }, e, n);
    }
    function c(t, e) {
      if (t === undefined || null === t) throw new Error("radians is required");
      if (e && "string" != typeof e) throw new Error("units must be a string");
      var n = v[e || "kilometers"];
    ...
    function f(t) {
      if (null === t || t === undefined) throw new Error("radians is required");
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      n.d(e, "earthRadius", function() {
        return m;
      }),
      n.d(e, "factors", function() {
        return v;
      }),
      n.d(e, "unitsFactors", function() {
        return E;
      }),
      n.d(e, "areaFactors", function() {
        return I;
      }),
      (e.feature = i),
      ...
      (e.geometryCollection = function(t, e, n) {
        ...
        return i({ type: "GeometryCollection", geometries: t }, e, n);
      }),
      (e.round = function(t, e) {
        if (t === undefined || null === t || isNaN(t))
      ...
      (e.convertLength = function(t, e, n) {
        ...
        return c(p(t, e), n || "kilometers");
      }),
      (e.convertArea = function(t, e, n) {
        if (null === t || t === undefined) throw new Error("area is required");
        if (!(t >= 0)) throw new Error("area must be a positive number");
        var i = I[e || "meters"];
        if (!i) throw new Error("invalid original units");
        var r = I[n || "kilometers"];
      ...
      for (n = 0; n < d; n++) {
        for (
          a = f ? t.features[n].geometry : g ? t.geometry : t,
            ...
            h = f ? t.features[n].bbox : g ? t.bbox : undefined,
            c = f ? t.features[n].id : g ? t.id : undefined,
    ...
    function o(t, e) {
      i(t, function(t, n, i, r, o) {
        ...
        switch (a) {
          ...
          case "LineString":
          case "Polygon":
            if (!1 === e(Object(s.a)(t, i, { bbox: r, id: o }), n, 0))
              return !1;
            return;
        }
        var u;
        ...
        for (var l = 0; l < t.coordinates.length; l++) {
          var h = { type: u, coordinates: t.coordinates[l] };
  ...
  function(t, e) {
    (Array.prototype.findIndex =
      ...
      function(t) {
        ...
        for (
          var e = Object(this), n = e.length >>> 0, i = arguments[1], r = 0;
          r < n;
          r++
        )
    ...
    var i = L.Class.extend({
      initialize: function(t) {
        ...
        (this.map = t),
          ...
          this.map.on("layerremove", function(t) {
  ...
  function(t, e, n) {
    ...
    var r = L.Class.extend({
      ...
      _defineButtons: function() {
        ...
        this._addButton("drawMarker", new L.Control.PMButton(r)),
          this._addButton("drawPolyline", new L.Control.PMButton(o)),
          ...
          this._addButton("cutPolygon", new L.Control.PMButton(i)),
          this._addButton("editMode", new L.Control.PMButton(u)),
          this._addButton("dragPolygon", new L.Control.PMButton(l)),
          this._addButton("removalMode", new L.Control.PMButton(e));
      },
  ...
  function(t, e, n) {
    ...
    var i = L.Control.extend({
      ...
      _makeButton: function(t) {
        ...
        return (
          t.iconUrl && i.setAttribute("src", t.iconUrl),
          t.className && L.DomUtil.addClass(i, t.className),
  ...
  function(t, e, n) {
    ...
    o["default"].Line = o["default"].extend({
      ...
      _handleSelfIntersection: function() {
        ...
        (this._doesSelfIntersect = e.features.length > 0),
    ...
    i["default"].Circle = i["default"].extend({
      ...
      _finishShape: function() {
        var t = this._centerMarker.getLatLng(),
          e = this._hintMarker.getLatLng(),
          n = t.distanceTo(e),
          i = L.circle(t, { radius: n }).addTo(this._map);
        this.disable(),
          this._map.fire("pm:create", { shape: this._shape, layer: i });
      },
      _createMarker: function(t) {
        var e = new L.Marker(t, {
          draggable: !1,
          ...
          .forEach(function(n) {
            ...
            if ("MultiPolygon" === r.geometry.type) {
              r.geometry.coordinates
                .reduce(function(t, e) {
                  return t.push({ type: "Polygon", coordinates: e }), t;
                }, [])
                .forEach(function(t) {
              ...
              i.push(s),
                s.addTo(e._map),
                s.pm.enable(e.options),
                s.pm.disable();
            }
            n.fire("pm:cut", { shape: e._shape, layer: n, resultingLayers: i }),
              e._map.fire("pm:cut", {
                shape: e._shape,
                cuttedLayer: n,
                resultingLayers: i
  ...
  function(t, e, n) {
    ...
    e["default"] = function(t, e, n) {
      ...
      var s = r.getGeom(t),
        a = r.getGeom(e);
      if ("Polygon" !== s.type) throw new Error("poly1 must be a Polygon");
      if ("Polygon" !== a.type) throw new Error("poly2 must be a Polygon");
      var u = i.intersection(s.coordinates, a.coordinates);
      if (null === u || 0 === u.length) return null;
      if (1 === u.length) {
        var l = u[0][0][0],
          h = u[0][0][u[0][0].length - 1];
        return l[0] === h[0] && l[1] === h[1]
          ? o.polygon(u[0], n.properties)
          : null;
      }
      return o.multiPolygon(u, n.properties);
    };
  },
  function(t, e, n) {
    var i;
      ...
      return (function t(e, n, r) {
      ...
      })(
        {
              ...
              !(function(t, i) {
                ...
                function t(e, n, i, r, o) {
                  if (e) {
                    r(n + (i ? "└── " : "├── ") + o(e) + "\n");
                    var s = n + (i ? "    " : "│   ");
                    e.left && t(e.left, s, !1, r, o),
                      e.right && t(e.right, s, !0, r, o);
                  }
                }
                function e(t) {
                  if (null === t) return !0;
                ...
                return (
                  ...
                  (o.prototype.insert = function(t, e) {
                    ...
                    if (this._noDuplicates)
                      ...
                      for (; s; )
                        (a = s),
                          (s = (u = o(t, s.key)) <= 0 ? s.left : s.right);
                    var l,
                      h = {
                        left: null,
                        right: null,
                    ...
                    for (
                      ...
                      if (a.balanceFactor < -1) {
                        1 === a.right.balanceFactor && r(a.right),
                          (l = i(a)),
                          a === n._root && (n._root = l);
                        break;
                      }
                  ...
                  (o.prototype.remove = function(t) {
                    ...
                    for (
                      var n = this._root, o = this._comparator, s = 0;
                      n && 0 !== (s = o(t, n.key));

                    )
                      n = s < 0 ? n.left : n.right;
                    if (!n) return null;
                    var a,
                      u,
                      l = n.key;
                    ...
                    if (n.right) {
                      for (u = n.right; u.left || u.right; ) {
                        ...
                        (n.key = u.key),
                          (n.data = u.data),
                          u.right && ((n = u), (u = u.right));
                      }
                      (n.key = u.key), (n.data = u.data), (n = u);
                    }
                    for (
                      var h, c = n.parent, p = n;
                      c &&
                      (c.left === p
                        ? (c.balanceFactor -= 1)
                        : (c.balanceFactor += 1),
                      c.balanceFactor < -1
                        ? (1 === c.right.balanceFactor && r(c.right),
                          (h = i(c)),
                          c === e._root && (e._root = h),
                          (c = h))
                        : c.balanceFactor > 1 &&
                          (-1 === c.left.balanceFactor && i(c.left),
                          (h = r(c)),
                          c === e._root && (e._root = h),
                          (c = h)),
            ...
            function(t, e, n) {
              ...
              (e.exports = i),
                ...
                (i.prototype = {
                  ...
                  _up: function(t) {
                    for (
                      var e = this.data, n = this.compare, i = e[t];
                      t > 0;
                    ...
                    : n[1] !== r[1]
                      ...
                      : (function(t, e, n, r) {
                          return t.left !== e.left
                            ? t.left ? 1 : -1
                            : 0 !== i(n, t.otherEvent.point, e.otherEvent.point)
                              ? t.isBelow(e.otherEvent.point) ? -1 : 1
                              : !t.isSubject && e.isSubject ? 1 : -1;
                        })(t, e, n);
              };
            },
            { "./signed_area": 16 }
          ...
          5: [
            function(t, e, n) {
              ...
              e.exports = function(t, e) {
                if (t === e) return 0;
                if (
                  0 !== i(t.point, t.otherEvent.point, e.point) ||
                  0 !== i(t.point, t.otherEvent.point, e.otherEvent.point)
                )
                  return o(t.point, e.point)
                    ? t.isBelow(e.otherEvent.point) ? -1 : 1
                    : t.point[0] === e.point[0]
                      ? t.point[1] < e.point[1] ? -1 : 1
                      : 1 === r(t, e)
                        ? e.isAbove(t.point) ? -1 : 1
                        : t.isBelow(e.point) ? -1 : 1;
                if (t.isSubject !== e.isSubject) return t.isSubject ? -1 : 1;
                var n = t.point,
                  s = e.point;
                return n[0] === s[0] && n[1] === s[1]
                  ? ((n = t.otherEvent.point),
                    (s = e.otherEvent.point),
                    n[0] === s[0] && n[1] === s[1]
                      ? 0
                      : t.contourId > e.contourId ? 1 : -1)
                  : 1 === r(t, e) ? 1 : -1;
              };
            },
            { "./compare_events": 4, "./equals": 10, "./signed_area": 16 }
          ],
          6: [
            function(t, e, n) {
              "use strict";
              ...
              e.exports = function(t, e, n) {
                null === e
                  ...
                  : (t.isSubject === e.isSubject
                    ...
                    e &&
                      (t.prevInResult =
                        !i(e, n) || e.isVertical() ? e.prevInResult : e)),
                  (t.inResult = i(t, n));
              };
            },
            { "./edge_type": 9, "./operation": 13 }
          ],
          7: [
            function(t, e, n) {
              "use strict";
              ...
              e.exports = function(t, e) {
                ...
                for (n = 0, s = u.length; n < s; n++)
                  if (!l[n]) {
                    var c = [[]];
                    u[n].isExteriorRing
                      ? e === o.DIFFERENCE && !u[n].isSubject && h.length > 1
                        ? h[h.length - 1].push(c[0])
                        : h.push(c)
                      : e !== o.DIFFERENCE || u[n].isSubject || 0 !== h.length
                        ? 0 === h.length
                          ? h.push([[c]])
                          : h[h.length - 1].push(c[0])
                        : h.push(c);
                    ...
                    for (c[0].push(g); f >= n; )
                      (a = u[f]),
                        (l[f] = !0),
                        a.left
                          ? ((a.resultInOut = !1), (a.contourId = p))
                          : ((a.otherEvent.resultInOut = !0),
                            (a.otherEvent.contourId = p)),
                        (l[(f = a.pos)] = !0),
                        c[0].push(u[f].point),
                        (f = i(f, u, l, n));
                    (a = u[(f = -1 === f ? n : f)]),
          ...
          8: [
            function(t, e, n) {
              ...
              e.exports = function(t, e, n) {
                ...
                return (
                  r(t.point, t.otherEvent.point) &&
                    console.warn("what is that, a collapsed segment?", t),
                  (s.contourId = a.contourId = t.contourId),
                  o(a, t.otherEvent) > 0 &&
                    ((t.otherEvent.left = !0), (a.left = !1)),
                  (t.otherEvent.otherEvent = a),
                  (t.otherEvent = s),
                  n.push(a),
                  n.push(s),
                  n
            ...
            { "./compare_events": 4, "./equals": 10, "./sweep_event": 18 }
          ],
          9: [
            function(t, e, n) {
              "use strict";
            ...
            function(t, e, n) {
              ...
              function i(t, e, n, i, r, a) {
                ...
                for (h = 0, c = t.length - 1; h < c; h++)
                  if (
                    ((p = t[h]),
                    (f = t[h + 1]),
                    (g = new o(p, !1, undefined, e)),
                    (d = new o(f, !1, g, e)),
                    (g.otherEvent = d),
                    p[0] !== f[0] || p[1] !== f[1])
                  ) {
                    (g.contourId = d.contourId = n),
                      a || ((g.isExteriorRing = !1), (d.isExteriorRing = !1)),
                      s(g, d) > 0 ? (d.left = !0) : (g.left = !0);
                    var _ = p[0],
                      y = p[1];
                    (r[0] = l(r[0], _)),
                      (r[1] = l(r[1], y)),
              ...
              e.exports = function(t, e, n, o, u) {
                ...
                for (p = 0, f = t.length; p < f; p++)
                  for (g = 0, d = (l = t[p]).length; g < d; g++)
                    (c = 0 === g) && h++, i(l[g], !0, h, _, n, c);
                for (p = 0, f = e.length; p < f; p++)
                  for (g = 0, d = (l = e[p]).length; g < d; g++)
                    (c = 0 === g),
                      u === a.DIFFERENCE && (c = !1),
                      c && h++,
                      i(l[g], !1, h, _, o, c);
          ...
          13: [
            function(t, e, n) {
              "use strict";
              e.exports = { INTERSECTION: 0, UNION: 1, DIFFERENCE: 2, XOR: 3 };
            },
            {}
          ],
          14: [
            function(t, e, n) {
              ...
              e.exports = function(t, e, n) {
                ...
                if (
                  1 === l &&
                  (o(t.point, e.point) ||
                    o(t.otherEvent.point, e.otherEvent.point))
                )
                  return 0;
                ...
                if (1 === l)
                  return (
                    o(t.point, u[0]) ||
                      o(t.otherEvent.point, u[0]) ||
                      i(t, u[0], n),
                    o(e.point, u[0]) ||
                      o(e.otherEvent.point, u[0]) ||
                      i(e, u[0], n),
                    1
                  );
                var h = [],
                ...
                return (
                  o(t.point, e.point)
                    ? (c = !0)
                    : 1 === s(t, e) ? h.push(e, t) : h.push(t, e),
                  o(t.otherEvent.point, e.otherEvent.point)
                    ? (p = !0)
                    : 1 === s(t.otherEvent, e.otherEvent)
                      ? h.push(e.otherEvent, t.otherEvent)
                      : h.push(t.otherEvent, e.otherEvent),
                  (c && p) || c
                    ? ((e.type = a.NON_CONTRIBUTING),
                      (t.type =
                        e.inOut === t.inOut
                          ? a.SAME_TRANSITION
                          : a.DIFFERENT_TRANSITION),
                      c && !p && i(h[1].otherEvent, h[0].point, n),
                      2)
                    : p
                      ? (i(h[0], h[1].point, n), 3)
                      : h[0] !== h[3].otherEvent
                        ? (i(h[0], h[1].point, n), i(h[1], h[2].point, n), 3)
                        : (i(h[0], h[1].point, n),
                          i(h[3].otherEvent, h[2].point, n),
                          3)
                );
              };
            },
          ...
          15: [
            function(t, e, n) {
              ...
              e.exports = function(t, e, n, o, s) {
                ...
                return v <= 1 && E >= 0
                  ? 1 === v
                    ? s ? null : [a(t, v > 0 ? v : 0, u)]
                    : 0 === E
                      ? s ? null : [a(t, E < 1 ? E : 1, u)]
                      : s && 0 === v && 1 === E
                        ? null
                        : [a(t, v > 0 ? v : 0, u), a(t, E < 1 ? E : 1, u)]
                  : null;
              };
            },
            {}
            ...
            function(t, e, n) {
              ...
              e.exports = function(t, e, n, u, l, h) {
                for (
                  ...
                  if (v.left) {
                    (p = c = g.insert(v)),
                      (c = c !== (f = g.minNode()) ? g.prev(c) : null),
                      (p = g.next(p));
                    var E,
                      I = c ? c.key : null;
                    if (
                      (r(v, I, h),
                      p && 2 === o(v, p.key, t) && (r(v, I, h), r(v, p.key, h)),
                      c && 2 === o(c.key, v, t))
                    ) {
                      var L = c;
                      (E = (L = L !== f ? g.prev(L) : null) ? L.key : null),
                        r(I, E, h),
                        r(v, I, h);
                    }
                  } else
  ...
  function(t, e, n) {
    "use strict";
    function i(t) {
      if (t.length > 1 && Object(r.isNumber)(t[0]) && Object(r.isNumber)(t[1]))
        return !0;
  ...
  function(t, e, n) {
    !(function(t, n) {
      ...
      function f() {
        (this.array_ = []),
          arguments[0] instanceof Et && this.addAll(arguments[0]);
      }
      function g() {}
      function d(t) {
        this.message = t || "";
      ...
      var I = function() {},
        ...
        b = function kr() {
          if (
            ...
            (this.x = 0), (this.y = 0), (this.z = kr.NULL_ORDINATE);
      ...
      (b.prototype.setOrdinate = function(t, e) {
        switch (t) {
          case b.X:
            this.x = e;
            break;
        ...
        (b.prototype.equals2D = function() {
          ...
          if (2 === arguments.length) {
            var e = arguments[0],
              n = arguments[1];
            return (
              !!y.equalsWithTolerance(this.x, e.x, n) &&
              !!y.equalsWithTolerance(this.y, e.y, n)
            );
          }
        }),
        (b.prototype.getOrdinate = function(t) {
          switch (t) {
            case b.X:
              return this.x;
            case b.Y:
        ...
        (b.prototype.equals3D = function(t) {
          return (
            this.x === t.x &&
            this.y === t.y &&
            (this.z === t.z || v.isNaN(this.z)) &&
            v.isNaN(t.z)
          );
        }),
        (b.prototype.equals = function(t) {
          return t instanceof b && this.equals2D(t);
        }),
        (b.prototype.equalInZ = function(t, e) {
        ...
        (b.prototype.compareTo = function(t) {
          ...
          return this.x < e.x
            ? -1
            : this.x > e.x ? 1 : this.y < e.y ? -1 : this.y > e.y ? 1 : 0;
        }),
        ...
        (b.prototype.distance3D = function(t) {
          var e = this.x - t.x,
            n = this.y - t.y,
            i = this.z - t.z;
        ...
        (b.prototype.hashCode = function() {
          var t = 17;
          return (
            (t = 37 * t + b.hashCode(this.x)), (t = 37 * t + b.hashCode(this.y))
          );
        }),
        (b.prototype.setCoordinate = function(t) {
          (this.x = t.x), (this.y = t.y), (this.z = t.z);
        }),
      ...
      (C.prototype.compare = function(t, e) {
        ...
        return 0 !== o
          ? o
          : this._dimensionsToTest <= 2 ? 0 : C.compare(n.z, i.z);
      }),
        ...
        (C.compare = function(t, e) {
          return t < e
            ...
            : t > e
              ? 1
              : v.isNaN(t) ? (v.isNaN(e) ? 0 : -1) : v.isNaN(e) ? 1 : 0;
        });
      var w = function() {};
      ...
      (k.prototype.le = function(t) {
        ...
        (k.prototype.extractSignificantDigits = function(t, e) {
          ...
          for (
            var o = i + 1, s = new R(), a = k.MAX_PRINT_DIGITS - 1, u = 0;
            u <= a;
            u++
          ) {
            t && u === o && s.append(".");
            ...
            l > 9 ? ((h = !0), (c = "9")) : (c = "0" + l),
              s.append(c),
              (n = n.subtract(k.valueOf(l)).multiply(k.TEN)),
              h && n.selfAdd(k.TEN);
            var p = !0,
              f = k.magnitude(n._hi);
        ...
        (k.prototype.compareTo = function(t) {
          ...
          return this._hi < e._hi
            ...
            : this._hi > e._hi
              ? 1
              : this._lo < e._lo ? -1 : this._lo > e._lo ? 1 : 0;
        }),
        ...
        (k.prototype.selfAdd = function() {
          if (1 === arguments.length) {
            ...
            (f = this._hi + u),
              ...
              (p = c - (_ = c - this._lo));
            var y =
                (h = f + (d = (g = u - d + (this._hi - g)) + c)) +
                (d = (p = l - _ + (this._lo - p)) + (d + (f - h))),
              m = d + (h - y);
        ...
        (k.prototype.reciprocal = function() {
          var t = null,
            ...
            s = null,
            a = null;
          (e = (r = 1 / this._hi) - (t = (o = k.SPLIT * r) - (t = o - r))),
            (n = (a = k.SPLIT * this._hi) - this._hi);
          var u =
            r +
            (o =
              (1 -
        ...
        (k.prototype.abs = function() {
          return this.isNaN()
            ? k.NaN
            : this.isNegative() ? this.negate() : new k(this);
        }),
        ...
        (k.prototype.trunc = function() {
          return this.isNaN()
            ? k.NaN
            : this.isPositive() ? this.floor() : this.ceil();
        }),
        (k.prototype.signum = function() {
          return this._hi > 0
            ? 1
            : this._hi < 0 ? -1 : this._lo > 0 ? 1 : this._lo < 0 ? -1 : 0;
        }),
                ...
                if ("e" === l || "E" === l) {
                  ...
                  try {
                    ...
                    throw e instanceof Error
                      ? new Error("Invalid exponent " + c + " in string " + t)
                      : e;
                  }
                  break;
                }
      ...
      var G = function() {},
        B = { DP_SAFE_EPSILON: { configurable: !0 } };
      ...
      (X.prototype.getY = function() {
        ...
        (X.intersection = function(t, e, n, i) {
          var r = t.y - e.y,
            ...
            c = (o * l - u * s) / h,
            p = (a * s - r * l) / h;
          if (v.isNaN(c) || v.isInfinite(c) || v.isNaN(p) || v.isInfinite(p))
            throw new z();
          return new b(c, p);
        });
      var Y = function Br() {
        ...
        H = { serialVersionUID: { configurable: !0 } };
      (Y.prototype.getArea = function() {
        ...
        (Y.prototype.hashCode = function() {
          var t = 17;
          return (
            (t = 37 * t + b.hashCode(this._minx)),
            (t = 37 * t + b.hashCode(this._maxx)),
            (t = 37 * t + b.hashCode(this._miny)),
            (t = 37 * t + b.hashCode(this._maxy))
          );
        }),
        (Y.prototype.interfaces_ = function() {
          return [I, e];
      ...
      (J.prototype.read = function(t) {
        ...
        if (
          (-1 !== t.search("EMPTY") &&
            ((r = W.emptyTypeStr.exec(t))[2] = void 0),
          r &&
            ((n = r[1].toLowerCase()),
            (i = r[2]),
            Z[n] && (e = Z[n].apply(this, [i]))),
          void 0 === e)
        )
        ...
        Z = {
          point: function(t) {
            ...
            return this.geometryFactory.createPoint(
              new b(Number.parseFloat(e[0]), Number.parseFloat(e[1]))
            );
          },
          multipoint: function(t) {
            ...
            for (
              ...
              (e = n[r].replace(W.trimParens, "$1")),
                i.push(Z.point.apply(this, [e]));
          ...
          linestring: function(t) {
            ...
            for (
              ...
              (e = n[r].trim().split(W.spaces)),
                i.push(new b(Number.parseFloat(e[0]), Number.parseFloat(e[1])));
          ...
          multilinestring: function(t) {
            ...
            for (
              ...
              (e = n[r].replace(W.trimParens, "$1")),
                i.push(Z.linestring.apply(this, [e]));
          ...
          polygon: function(t) {
            ...
            for (
              ...
              (e = o[a].replace(W.trimParens, "$1")),
                (n = Z.linestring.apply(this, [e])),
          ...
          multipolygon: function(t) {
            ...
            for (
              var e,
                n = t.trim().split(W.doubleParenComma),
                i = [],
                r = 0,
                o = n.length;
              r < o;
          ...
          return (
            ...
            (e.prototype.intersection = function(t, n, i, r) {
              ...
              return (
                this.isInSegmentEnvelopes(o) ||
                  (o = new b(e.nearestEndpoint(t, n, i, r))),
            ...
            (e.prototype.checkDD = function(t, e, n, i, r) {
              ...
              j.out.println(
                ...
                r.distance(o) > 1e-4 &&
                  j.out.println("Distance = " + r.distance(o));
            }),
                      ...
                      ? ((this._isProper = !1),
                        e.equals2D(i) || e.equals2D(r)
                          ...
                          : n.equals2D(i) || n.equals2D(r)
                            ? (this._intPt[0] = n)
                            : 0 === o
                              ? (this._intPt[0] = new b(i))
                              : 0 === s
                                ? (this._intPt[0] = new b(r))
                                : 0 === a
                                  ? (this._intPt[0] = new b(e))
                                  : 0 === u && (this._intPt[0] = new b(n)))
                      : ((this._isProper = !0),
      ...
      (st.prototype.countSegment = function(t, e) {
        ...
        (st.prototype.getLocation = function() {
          return this._isPointOnSegment
            ? S.BOUNDARY
            : this._crossingCount % 2 == 1 ? S.INTERIOR : S.EXTERIOR;
        }),
        ...
        (st.locatePointInRing = function() {
          if (arguments[0] instanceof b && O(arguments[1], q)) {
            for (
              var t = arguments[0],
                e = arguments[1],
                n = new st(t),
          ...
          if (arguments[0] instanceof b && arguments[1] instanceof Array) {
            for (
              var s = arguments[0], a = arguments[1], u = new st(s), l = 1;
              l < a.length;
              l++
            ) {
              var h = a[l],
                c = a[l - 1];
              if ((u.countSegment(h, c), u.isOnSegment()))
          ...
          if (1 === arguments.length) {
            ...
            return this.getSortIndex() !== e.getSortIndex()
              ...
              : this.isEmpty() && e.isEmpty()
                ...
                : this.isEmpty()
                  ? -1
                  : e.isEmpty() ? 1 : this.compareToSameClass(t);
          }
          if (2 === arguments.length) {
            var n = arguments[0],
              i = arguments[1];
            return this.getSortIndex() !== n.getSortIndex()
              ...
              : this.isEmpty() && n.isEmpty()
                ...
                : this.isEmpty()
                  ? -1
                  : n.isEmpty() ? 1 : this.compareToSameClass(n, i);
          }
        }),
      ...
      (Et.prototype.add = function() {}),
        (Et.prototype.addAll = function() {}),
        (Et.prototype.isEmpty = function() {}),
        (Et.prototype.iterator = function() {}),
        ...
        Nt = (function(t) {
          ...
          return (
            ...
            (e.prototype.closeRing = function() {
              this.size() > 0 && this.add(new b(this.get(0)), !1);
            }),
            (e.prototype.interfaces_ = function() {
              return [];
            }),
      ...
      (wt.ForwardComparator.get = function() {
        return St;
      }),
        ...
        (Ct.scroll = function(t, e) {
          ...
          j.arraycopy(t, n, i, 0, t.length - n),
            j.arraycopy(t, 0, i, t.length - n, n),
            j.arraycopy(i, 0, t, 0, t.length);
        }),
        (Ct.equals = function() {
          if (2 === arguments.length) {
            var t = arguments[0],
        ...
        (Ct.intersection = function(t, e) {
          for (var n = new Nt(), i = 0; i < t.length; i++)
      ...
      ((r.prototype = new Error()).name = "OperationNotSupported"),
        ((o.prototype = new Et()).contains = function() {});
      var Pt = (function(t) {
          function e() {
            t.call(this),
              (this.array_ = []),
        ...
        (c.prototype.fixAfterInsertion = function(t) {
          for (
            ...
            if (a(t) === l(a(a(t)))) {
              var e = h(a(a(t)));
              1 === s(e)
                ? (u(a(t), Dt), u(e, Dt), u(a(a(t)), 1), (t = a(a(t))))
              ...
              var n = l(a(a(t)));
              1 === s(n)
                ? (u(a(t), Dt), u(n, Dt), u(a(a(t)), 1), (t = a(a(t))))
                : (t === l(a(t)) && ((t = a(t)), this.rotateRight(t)),
                  u(a(t), Dt),
                  u(a(a(t)), 1),
      ...
      (jt.prototype.boundaryMultiLineString = function(t) {
        ...
        (jt.prototype.addEndpoint = function(t) {
          ...
          null === e && ((e = new Xt()), this._endpointMap.put(t, e)),
            e.count++;
        }),
      ...
      (Yt.prototype.interfaces_ = function() {
          ...
          if (2 === arguments.length) {
            for (
              var i = arguments[0],
                r = arguments[1],
                o = "",
                s = new function() {}(new function() {}(Yt.getStackTrace(i))),
                a = 0;
              a < r;
              a++
            )
        ...
        (Yt.split = function(t, e) {
          for (
            var n = e.length, i = new xt(), r = "" + t, o = r.indexOf(e);
            o >= 0;
      ...
      (Wt.prototype.interfaces_ = function() {
        ...
        (Wt.isRing = function(t) {
          ...
          return (
            0 === e ||
            (!(e <= 3) &&
              t.getOrdinate(0, q.X) === t.getOrdinate(e - 1, q.X) &&
              t.getOrdinate(0, q.Y) === t.getOrdinate(e - 1, q.Y))
          );
        }),
        ...
        (Wt.toString = function() {
          if (1 === arguments.length) {
            ...
            for (var r = 0; r < e; r++) {
              ...
              for (var o = 0; o < n; o++)
                o > 0 && i.append(","),
                  i.append(Yt.toString(t.getOrdinate(r, o)));
            }
        ...
        (Wt.ensureValidRing = function(t, e) {
          ...
          return 0 === n
            ? e
            : n <= 3
              ? Wt.createClosedRing(t, e, 4)
              : e.getOrdinate(0, q.X) === e.getOrdinate(n - 1, q.X) &&
                e.getOrdinate(0, q.Y) === e.getOrdinate(n - 1, q.Y)
                ? e
                : Wt.createClosedRing(t, e, n + 1);
        }),
      ...
      var Jt = (function(t) {
          ...
          return (
            (e.prototype.computeEnvelopeInternal = function() {
              return this.isEmpty()
                ? new Y()
                : this._points.expandEnvelope(new Y());
            }),
            ...
            (e.prototype.apply = function() {
              if (O(arguments[0], ft))
                ...
                O(arguments[0], qt)
                  ...
                  : O(arguments[0], lt) && arguments[0].filter(this);
            }),
            (e.prototype.getBoundary = function() {
              return new jt(this).getBoundary();
            }),
          ...
          return (
            ...
            (e.prototype.normalize = function() {
              if (0 === arguments.length) {
                ...
                Ct.scroll(i, r),
                  j.arraycopy(i, 0, e.getCoordinates(), 0, i.length),
      ...
      (ie.prototype.setCopyUserData = function(t) {
        ...
        (ie.prototype.editGeometryCollection = function(t, e) {
          for (
            var n = e.edit(t, this._factory), i = new xt(), r = 0;
        ...
        return null === n
          ...
          : t instanceof ee
            ...
            : t instanceof Jt
              ...
              : t instanceof Zt
                ? n.length > 0 ? e.createPoint(n[0]) : e.createPoint()
                : t;
      }),
      ...
      var ue = function() {
          if (
            ...
            if (arguments[0] instanceof Array)
              ...
              for (var e = 0; e < t; e++) this._coordinates[e] = new b();
            ...
            if (
              ...
              (this._coordinates = new Array(s).fill(null)),
                (this._dimension = a);
              for (var u = 0; u < s; u++) this._coordinates[u] = new b();
            }
        },
        le = { serialVersionUID: { configurable: !0 } };
      (ue.prototype.setOrdinate = function(t, e, n) {
        ...
        (ue.prototype.getCoordinateCopy = function(t) {
          return new b(this._coordinates[t]);
        }),
      ...
      var pe = (function(t) {
          ...
          return (
            ...
            (e.prototype.values = function() {
              for (
                var t = new xt(), e = this.map_.values(), n = e.next();
                !n.done;
      ...
      (de.prototype.readResolve = function() {
        ...
        Object.defineProperties(de, _e),
        (fe.Type = de),
        (fe.FIXED = new de("FIXED")),
        (fe.FLOATING = new de("FLOATING")),
        (fe.FLOATING_SINGLE = new de("FLOATING SINGLE"));
      var ye = function Vr() {
          (this._precisionModel = new fe()),
            (this._SRID = 0),
            (this._coordinateSequenceFactory = Vr.getDefaultCoordinateSequenceFactory()),
            0 === arguments.length ||
              (1 === arguments.length
                ? O(arguments[0], w)
      ...
      (ye.prototype.toGeometry = function(t) {
        ...
        (ye.prototype.buildGeometry = function(t) {
          ...
          if (n || i)
            return this.createGeometryCollection(ye.toGeometryArray(t));
          var a = t.iterator().next();
          if (t.size() > 1) {
            if (a instanceof $t)
              return this.createMultiPolygon(ye.toPolygonArray(t));
            if (a instanceof Jt)
              return this.createMultiLineString(ye.toLineStringArray(t));
            if (a instanceof Zt)
              return this.createMultiPoint(ye.toPointArray(t));
            et.shouldNeverReachHere(
      ...
      (Ee.prototype.read = function(t) {
        ...
        return -1 !== ve.indexOf(n)
          ? Ie[n].apply(this, [e.coordinates])
          : "GeometryCollection" === n
            ? Ie[n].apply(this, [e.geometries])
            : Ie[n].apply(this, [e]);
      }),
      ...
      var Ie = {
          ...
          MultiPoint: function(t) {
            for (var e = [], n = 0; n < t.length; ++n)
              e.push(Ie.Point.apply(this, [t[n]]));
          ...
          MultiLineString: function(t) {
            for (var e = [], n = 0; n < t.length; ++n)
              e.push(Ie.LineString.apply(this, [t[n]]));
            return this.geometryFactory.createMultiLineString(e);
          },
          Polygon: function(t) {
            for (
              var e = Ie.coordinates.apply(this, [t[0]]),
      ...
      (Ne.prototype.interfaces_ = function() {
        ...
        ((d.prototype = new Error()).name = "EmptyStackException"),
        ((_.prototype = new Lt()).add = function(t) {
          return this.array_.push(t), !0;
        }),
      ...
      (we.prototype.getCoordinate = function() {
        ...
        (we.prototype.getRightmostSideOfSegment = function(t, e) {
          ...
          var i = Ne.LEFT;
          return n[e].y < n[e + 1].y && (i = Ne.RIGHT), i;
        }),
        ...
        (we.prototype.findEdge = function(t) {
          ...
          et.isTrue(
            ...
            this.getRightmostSide(this._minDe, this._minIndex) === Ne.LEFT &&
      ...
      (Oe.prototype.clearVisitedEdges = function() {
        ...
        (Oe.prototype.compareTo = function(t) {
          ...
          return this._rightMostCoord.x < e._rightMostCoord.x
            ? -1
            : this._rightMostCoord.x > e._rightMostCoord.x ? 1 : 0;
        }),
        (Oe.prototype.getEnvelope = function() {
          if (null === this._env) {
            for (
              var t = new Y(), e = this._dirEdgeList.iterator();
              e.hasNext();
      ...
      var Te = function zr() {
        if (((this.location = null), 1 === arguments.length)) {
          if (arguments[0] instanceof Array) {
            ...
            var e = arguments[0];
            this.init(1), (this.location[Ne.ON] = e);
          ...
          var r = arguments[0],
            ...
            s = arguments[2];
          this.init(3),
            (this.location[Ne.ON] = r),
            (this.location[Ne.LEFT] = o),
            (this.location[Ne.RIGHT] = s);
        }
      };
        ...
        (Te.prototype.toString = function() {
          ...
          return (
            this.location.length > 1 &&
              t.append(S.toLocationSymbol(this.location[Ne.LEFT])),
            t.append(S.toLocationSymbol(this.location[Ne.ON])),
            this.location.length > 1 &&
              t.append(S.toLocationSymbol(this.location[Ne.RIGHT])),
            t.toString()
          );
        }),
      ...
      var Pe = function jr() {
        if (((this.elt = new Array(2).fill(null)), 1 === arguments.length)) {
          ...
          var n = arguments[0],
            i = arguments[1];
          (this.elt[0] = new Te(S.NONE)),
            (this.elt[1] = new Te(S.NONE)),
          ...
          var a = arguments[0],
            ...
            l = arguments[2],
            h = arguments[3];
          (this.elt[0] = new Te(S.NONE, S.NONE, S.NONE)),
            (this.elt[1] = new Te(S.NONE, S.NONE, S.NONE)),
      ...
      (Pe.prototype.getGeometryCount = function() {
        ...
        (Pe.prototype.toLine = function(t) {
          this.elt[t].isArea() &&
            (this.elt[t] = new Te(this.elt[t].location[0]));
        }),
        ...
        (Pe.toLineLabel = function(t) {
          for (var e = new Pe(S.NONE), n = 0; n < 2; n++)
      ...
      (Re.prototype.computeRing = function() {
        ...
        (Re.prototype.mergeLabel = function() {
          if (1 === arguments.length) {
            ...
            var e = arguments[0],
              n = arguments[1],
              i = e.getLocation(n, Ne.RIGHT);
            if (i === S.NONE) return null;
            if (this._label.getLocation(n) === S.NONE)
            ...
            (e.prototype.mergeLabel = function() {
              if (arguments[0] instanceof e) {
                ...
                for (var n = arguments[0], i = 0; i < 2; i++) {
                  ...
                  this._label.getLocation(i) === S.NONE &&
      ...
      (Ue.prototype.compareDirection = function(t) {
        ...
        (Ue.prototype.init = function(t, e) {
          (this._p0 = t),
            ...
            (this._dx = e.x - t.x),
            (this._dy = e.y - t.y),
            (this._quadrant = Be.quadrant(this._dx, this._dy)),
            et.isTrue(
      ...
      var Ve = (function(t) {
          ...
          return (
            ...
            (e.prototype.computeDirectedLabel = function() {
              (this._label = new Pe(this._edge.getLabel())),
            ...
            (e.prototype.isInteriorAreaEdge = function() {
              for (var t = !0, e = 0; e < 2; e++)
                (this._label.isArea(e) &&
                  this._label.getLocation(e, Ne.LEFT) === S.INTERIOR &&
                  this._label.getLocation(e, Ne.RIGHT) === S.INTERIOR) ||
                  (t = !1);
              return t;
            }),
            ...
            (e.prototype.isLineEdge = function() {
              var t = this._label.isLine(0) || this._label.isLine(1),
                e =
                  ...
                  this._label.allPositionsEqual(0, S.EXTERIOR),
                n =
                  !this._label.isArea(1) ||
                  this._label.allPositionsEqual(1, S.EXTERIOR);
              return t && e && n;
            }),
            ...
            (e.depthFactor = function(t, e) {
              return t === S.EXTERIOR && e === S.INTERIOR
                ? 1
                : t === S.INTERIOR && e === S.EXTERIOR ? -1 : 0;
            }),
            e
          );
        })(Ue),
      ...
      var je = function() {
        if (
          ((this._edges = new xt()),
          (this._nodes = null),
          (this._edgeEndList = new xt()),
          0 === arguments.length)
        )
          this._nodes = new Ge(new ze());
        else if (1 === arguments.length) {
          var t = arguments[0];
      ...
      (je.prototype.printEdges = function(t) {
        ...
        (je.prototype.matchInSameDirection = function(t, e, n, i) {
          return (
            ...
            Be.quadrant(t, e) === Be.quadrant(n, i)
          );
        }),
      ...
      (Xe.prototype.sortShellsAndHoles = function(t, e, n) {
        ...
        (Xe.prototype.findEdgeRingContaining = function(t, e) {
          for (
            ...
            var c = !1;
            h.contains(i) &&
              at.isPointInRing(r, l.getCoordinates()) &&
              (c = !0),
      ...
      (tn.prototype.expandToQueue = function(t, e) {
        ...
        (tn.prototype.compareTo = function(t) {
          ...
          return this._distance < e._distance
            ? -1
            : this._distance > e._distance ? 1 : 0;
        }),
      ...
      var en = function Xr() {
          if (
            ...
            var e = arguments[0];
            et.isTrue(e > 1, "Node capacity must be greater than 1"),
      ...
      (en.prototype.getNodeCapacity = function() {
        ...
        (en.prototype.insert = function(t, e) {
          et.isTrue(
            ...
            this._itemBoundables.add(new He(t, e));
        }),
          ...
          if (3 === arguments.length) {
            ...
            for (var o = i.getChildBoundables().iterator(); o.hasNext(); ) {
              ...
              s instanceof Ze
                ...
                : (et.isTrue(s instanceof He), -1 === n && r.add(s));
            }
            return null;
          }
        }),
      ...
      var sn = (function(t) {
          ...
          return (
            (n.prototype.createParentBoundablesFromVerticalSlices = function(
              ...
              for (var n = new xt(), i = 0; i < t.length; i++)
            ...
            (n.prototype.nearestNeighbour = function() {
              if (1 === arguments.length) {
                ...
                if (
                  ...
                  return [
                    l.getBoundable(0).getItem(),
                    l.getBoundable(1).getItem()
                  ];
                }
              } else if (3 === arguments.length) {
                var f = arguments[0],
      ...
      (hn.prototype.getSplitCoordinates = function() {
        ...
        (hn.prototype.createSplitEdge = function(t, e) {
          ...
          return r && (o[s] = new b(e.coord)), new gn(o, this._edge.getData());
        }),
      ...
      var dn = function() {
          if (((this.p0 = null), (this.p1 = null), 0 === arguments.length))
            (this.p0 = new b()), (this.p1 = new b());
          else if (1 === arguments.length) {
            var t = arguments[0];
            (this.p0 = new b(t.p0)), (this.p1 = new b(t.p1));
          } else if (2 === arguments.length)
            ...
            var e = arguments[0],
              ...
              i = arguments[2],
              r = arguments[3];
            (this.p0 = new b(e, n)), (this.p1 = new b(i, r));
          }
        },
        _n = { serialVersionUID: { configurable: !0 } };
      (dn.prototype.minX = function() {
        ...
        (dn.prototype.project = function() {
          if (arguments[0] instanceof b) {
            var t = arguments[0];
            if (t.equals(this.p0) || t.equals(this.p1)) return new b(t);
        ...
        (dn.prototype.closestPoint = function(t) {
          ...
          return e > 0 && e < 1
            ? this.project(t)
            : this.p0.distance(t) < this.p1.distance(t) ? this.p0 : this.p1;
        }),
      ...
      var yn = function() {
        (this.tempEnv1 = new Y()),
          (this.tempEnv2 = new Y()),
          (this._overlapSeg1 = new dn()),
          (this._overlapSeg2 = new dn());
      };
      ...
      (mn.prototype.getLineSegment = function(t, e) {
        ...
        (mn.prototype.computeOverlapsInternal = function(t, e, n, i, r, o) {
          ...
          var h = Math.trunc((t + e) / 2),
            c = Math.trunc((i + r) / 2);
          t < h &&
            (i < c && this.computeOverlapsInternal(t, h, n, i, c, o),
            c < r && this.computeOverlapsInternal(t, h, n, c, r, o)),
            h < e &&
              (i < c && this.computeOverlapsInternal(h, e, n, i, c, o),
              c < r && this.computeOverlapsInternal(h, e, n, c, r, o));
        }),
      ...
      (vn.prototype.interfaces_ = function() {
        ...
        (vn.findChainEnd = function(t, e) {
          ...
          for (
            var i = Be.quadrant(t[n], t[n + 1]), r = e + 1;
            r < t.length &&
            (t[r - 1].equals2D(t[r]) || Be.quadrant(t[r - 1], t[r]) === i);
      ...
      var En = function() {};
      (En.prototype.computeNodes = function(t) {}),
        (En.prototype.getNodedSubstrings = function() {}),
        (En.prototype.interfaces_ = function() {
          return [];
        }),
        (En.prototype.getClass = function() {
      ...
      var Ln = (function(t) {
          ...
          return (
            ...
            (e.prototype.add = function(t) {
              for (
                var e = vn.getChains(t.getCoordinates(), t).iterator();
                e.hasNext();
            ...
            (e.prototype.intersectChains = function() {
              for (
                var t = new xn(this._segInt), e = this._monoChains.iterator();
                e.hasNext();
        ...
        bn = function Yr() {
          if (
            ((this._quadrantSegments = Yr.DEFAULT_QUADRANT_SEGMENTS),
            (this._endCapStyle = Yr.CAP_ROUND),
            (this._joinStyle = Yr.JOIN_ROUND),
            (this._mitreLimit = Yr.DEFAULT_MITRE_LIMIT),
            (this._isSingleSided = !1),
            (this._simplifyFactor = Yr.DEFAULT_SIMPLIFY_FACTOR),
            0 === arguments.length)
          );
          else if (1 === arguments.length) {
            var t = arguments[0];
      ...
      (bn.prototype.getEndCapStyle = function() {
        return this._endCapStyle;
      }),
        (bn.prototype.isSingleSided = function() {
          return this._isSingleSided;
        }),
        (bn.prototype.setQuadrantSegments = function(t) {
          (this._quadrantSegments = t),
            0 === this._quadrantSegments && (this._joinStyle = bn.JOIN_BEVEL),
            this._quadrantSegments < 0 &&
              ((this._joinStyle = bn.JOIN_MITRE),
              (this._mitreLimit = Math.abs(this._quadrantSegments))),
            t <= 0 && (this._quadrantSegments = 1),
            this._joinStyle !== bn.JOIN_ROUND &&
              (this._quadrantSegments = bn.DEFAULT_QUADRANT_SEGMENTS);
        }),
        (bn.prototype.getJoinStyle = function() {
          return this._joinStyle;
        }),
        (bn.prototype.setJoinStyle = function(t) {
          this._joinStyle = t;
        }),
        (bn.prototype.setSimplifyFactor = function(t) {
          this._simplifyFactor = t < 0 ? 0 : t;
        }),
        (bn.prototype.getSimplifyFactor = function() {
          return this._simplifyFactor;
        }),
        (bn.prototype.getQuadrantSegments = function() {
          return this._quadrantSegments;
        }),
        (bn.prototype.setEndCapStyle = function(t) {
          this._endCapStyle = t;
        }),
        (bn.prototype.getMitreLimit = function() {
          return this._mitreLimit;
        }),
        (bn.prototype.setMitreLimit = function(t) {
          this._mitreLimit = t;
        }),
        (bn.prototype.setSingleSided = function(t) {
        ...
        (bn.bufferDistanceError = function(t) {
          var e = Math.PI / 2 / t;
      ...
      var Sn = function() {
        ...
        Mn = { COORDINATE_ARRAY_TYPE: { configurable: !0 } };
      (Sn.prototype.getCoordinates = function() {
        ...
        (Sn.prototype.revere = function() {}),
        (Sn.prototype.addPts = function(t, e) {
        ...
        (Sn.prototype.closeRing = function() {
          ...
          var t = new b(this._ptList.get(0)),
      ...
      var Pn = function Hr() {
          (this._maxCurveSegmentError = 0),
            ...
            (this._seg0 = new dn()),
            (this._seg1 = new dn()),
            (this._offset0 = new dn()),
            (this._offset1 = new dn()),
            (this._side = 0),
          ...
          (this._precisionModel = t),
            ...
            e.getQuadrantSegments() >= 8 &&
              e.getJoinStyle() === bn.JOIN_ROUND &&
              (this._closingSegLengthFactor = Hr.MAX_CLOSING_SEG_LEN_FACTOR),
            this.init(n);
        },
        Rn = {
      ...
      (Pn.prototype.addNextSegment = function(t, e) {
        ...
        var n = at.computeOrientation(this._s0, this._s1, this._s2),
          i =
            (n === at.CLOCKWISE && this._side === Ne.LEFT) ||
            (n === at.COUNTERCLOCKWISE && this._side === Ne.RIGHT);
        0 === n
          ? this.addCollinear(e)
          : i ? this.addOutsideTurn(n, e) : this.addInsideTurn(n, e);
      }),
        (Pn.prototype.addLineEndCap = function(t, e) {
          var n = new dn(t, e),
            i = new dn();
          this.computeOffsetSegment(n, Ne.LEFT, this._distance, i);
          var r = new dn();
          this.computeOffsetSegment(n, Ne.RIGHT, this._distance, r);
          var o = e.x - t.x,
            s = e.y - t.y,
            a = Math.atan2(s, o);
          switch (this._bufParams.getEndCapStyle()) {
            ...
            case bn.CAP_SQUARE:
              ...
              var l = new b(i.p1.x + u.x, i.p1.y + u.y),
                h = new b(r.p1.x + u.x, r.p1.y + u.y);
        ...
        (Pn.prototype.addMitreJoin = function(t, e, n, i) {
          var r = !0,
            o = null;
          try {
            (o = X.intersection(e.p0, e.p1, n.p0, n.p1)),
        ...
        (Pn.prototype.addOutsideTurn = function(t, e) {
          if (
            ...
            this._distance * Pn.OFFSET_SEGMENT_SEPARATION_FACTOR
          )
            return this._segList.addPt(this._offset0.p1), null;
          this._bufParams.getJoinStyle() === bn.JOIN_MITRE
            ? this.addMitreJoin(
                this._s1,
                this._offset0,
                this._offset1,
            ...
            : this._bufParams.getJoinStyle() === bn.JOIN_BEVEL
        ...
        (Pn.prototype.createSquare = function(t) {
          this._segList.addPt(
            new b(t.x + this._distance, t.y + this._distance)
          ),
            this._segList.addPt(
              new b(t.x + this._distance, t.y - this._distance)
            ),
        ...
        (Pn.prototype.addLimitedMitreJoin = function(t, e, n, i) {
          ...
          this._side === Ne.LEFT
            ? (this._segList.addPt(d), this._segList.addPt(_))
            : (this._segList.addPt(_), this._segList.addPt(d));
        }),
        ...
        (Pn.prototype.addFilletArc = function(t, e, n, i, r) {
          ...
          if (a < 1) return null;
          for (var u = s / a, l = 0, h = new b(); l < s; ) {
            var c = e + o * l;
            (h.x = t.x + r * Math.cos(c)),
              (h.y = t.y + r * Math.sin(c)),
        ...
        (Pn.prototype.addInsideTurn = function(t, e) {
          if (
            ...
            this._offset0.p1.distance(this._offset1.p0) <
              this._distance * Pn.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR)
          )
        ...
        (Pn.prototype.init = function(t) {
          (this._distance = t),
            ...
            (this._segList = new Sn()),
            this._segList.setPrecisionModel(this._precisionModel),
            this._segList.setMinimumVertexDistance(
              t * Pn.CURVE_VERTEX_SNAP_DISTANCE_FACTOR
            );
        }),
      ...
      (Dn.prototype.getOffsetCurve = function(t, e) {
        ...
        (Dn.prototype.computeSingleSidedBufferCurve = function(t, e, n) {
          ...
          if (e) {
            ...
            var r = Cn.simplify(t, -i),
              o = r.length - 1;
            n.initSideSegments(r[o], r[o - 1], Ne.LEFT), n.addFirstSegment();
            for (var s = o - 2; s >= 0; s--) n.addNextSegment(r[s], !0);
          } else {
            n.addSegments(t, !1);
            var a = Cn.simplify(t, i),
              u = a.length - 1;
            n.initSideSegments(a[0], a[1], Ne.LEFT), n.addFirstSegment();
        ...
        (Dn.prototype.computeLineBufferCurve = function(t, e) {
          var n = this.simplifyTolerance(this._distance),
            i = Cn.simplify(t, n),
            r = i.length - 1;
          e.initSideSegments(i[0], i[1], Ne.LEFT);
      ...
      (An.prototype.findStabbedSegments = function() {
        if (1 === arguments.length) {
          for (
            var t = arguments[0], e = new xt(), n = this._subgraphs.iterator();
            n.hasNext();
          ...
          if (
            ...
            for (
              ...
              if (
                ...
                this._seg.p0.equals(u[l]) || (h = s.getDepth(Ne.RIGHT));
      ...
      (Bn.prototype.addPoint = function(t) {
        ...
        (Bn.prototype.addPolygon = function(t) {
          var e = this._distance,
            n = Ne.LEFT;
          this._distance < 0 && ((e = -this._distance), (n = Ne.RIGHT));
          ...
          for (var o = 0; o < t.getNumInteriorRing(); o++) {
            ...
            (this._distance > 0 &&
              ...
              this.addPolygonRing(a, e, Ne.opposite(n), S.INTERIOR, S.EXTERIOR);
          }
        }),
        ...
        (Bn.prototype.addCurve = function(t, e, n) {
          ...
          var i = new gn(t, new Pe(0, S.BOUNDARY, e, n));
              ...
              : t instanceof Zt
                ...
                : t instanceof te
                  ...
                  : t instanceof zt
                    ...
                    : t instanceof ne
                      ? this.addCollection(t)
                      : t instanceof Vt && this.addCollection(t);
        }),
      ...
      (Vn.prototype.locate = function(t) {
        ...
        (Vn.locate = function(t, e) {
          return e.isEmpty()
            ? S.EXTERIOR
            : Vn.containsPoint(t, e) ? S.INTERIOR : S.EXTERIOR;
        });
      var zn = function() {
        (this._edgeMap = new c()),
          (this._edgeList = null),
          (this._ptInAreaLocation = [S.NONE, S.NONE]);
      };
      (zn.prototype.getNextCW = function(t) {
        ...
        (zn.prototype.propagateSideLabels = function(t) {
          for (var e = S.NONE, n = this.iterator(); n.hasNext(); ) {
            ...
            i.isArea(t) &&
              i.getLocation(t, Ne.LEFT) !== S.NONE &&
              (e = i.getLocation(t, Ne.LEFT));
          }
          ...
          for (var r = e, o = this.iterator(); o.hasNext(); ) {
            var s = o.next(),
              a = s.getLabel();
            if (
              (a.getLocation(t, Ne.ON) === S.NONE && a.setLocation(t, Ne.ON, r),
              a.isArea(t))
            ) {
              var u = a.getLocation(t, Ne.LEFT),
                l = a.getLocation(t, Ne.RIGHT);
              if (l !== S.NONE) {
                if (l !== r)
                  throw new Se("side location conflict", s.getCoordinate());
                u === S.NONE &&
                  et.shouldNeverReachHere(
                ...
                et.isTrue(
                  a.getLocation(t, Ne.LEFT) === S.NONE,
                  "found single null side"
                ),
                  a.setLocation(t, Ne.RIGHT, r),
                  a.setLocation(t, Ne.LEFT, r);
            }
          }
        }),
        ...
        (zn.prototype.getEdges = function() {
          return (
            null === this._edgeList &&
              (this._edgeList = new xt(this._edgeMap.values())),
            this._edgeList
          );
        }),
        (zn.prototype.getLocation = function(t, e, n) {
          return (
            this._ptInAreaLocation[t] === S.NONE &&
              (this._ptInAreaLocation[t] = Vn.locate(e, n[t].getGeometry())),
        ...
        (zn.prototype.computeLabelling = function(t) {
          ...
          for (var e = [!1, !1], n = this.iterator(); n.hasNext(); )
            for (var i = n.next().getLabel(), r = 0; r < 2; r++)
              i.isLine(r) && i.getLocation(r) === S.BOUNDARY && (e[r] = !0);
          ...
          return (
            ...
            (e.prototype.getRightmostEdge = function() {
              ...
              var i = t.get(e - 1),
                r = n.getQuadrant(),
                o = i.getQuadrant();
              return Be.isNorthern(r) && Be.isNorthern(o)
                ? n
                : Be.isNorthern(r) || Be.isNorthern(o)
                  ? 0 !== n.getDy()
                    ? n
                    : 0 !== i.getDy()
                      ? i
            ...
            (e.prototype.computeDepths = function() {
              if (1 === arguments.length) {
                var t = arguments[0],
                  e = this.findIndex(t),
                  n = t.getDepth(Ne.LEFT),
                  i = t.getDepth(Ne.RIGHT),
                  r = this.computeDepths(e + 1, this._edgeList.size(), n);
                if (this.computeDepths(0, e, r) !== i)
                  throw new Se("depth mismatch at " + t.getCoordinate());
              } else if (3 === arguments.length) {
                for (
                  var o = arguments[0],
                    s = arguments[1],
                  ...
                  l.setEdgeDepths(Ne.RIGHT, a), (a = l.getDepth(Ne.LEFT));
                }
                return a;
              }
            }),
            ...
            (e.prototype.findCoveredLineEdges = function() {
              ...
              for (var r = t, o = this.iterator(); o.hasNext(); ) {
                var s = o.next(),
                  a = s.getSym();
                s.isLineEdge()
                  ? s.getEdge().setCovered(r === S.INTERIOR)
                  : (s.isInResult() && (r = S.EXTERIOR),
                    a.isInResult() && (r = S.INTERIOR));
              }
            }),
            (e.prototype.computeLabelling = function(e) {
              ...
              for (var n = this.iterator(); n.hasNext(); )
                for (
                  ...
                  (o !== S.INTERIOR && o !== S.BOUNDARY) ||
                    this._label.setLocation(r, S.INTERIOR);
                }
            }),
            (e.prototype.interfaces_ = function() {
              return [];
      ...
      var Wn = function() {};
      (Wn.prototype.processIntersections = function(t, e, n, i) {}),
      ...
      (Qn.prototype.getChainStartIndices = function(t) {
        ...
        (Qn.prototype.findChainEnd = function(t, e) {
          for (
            var n = Be.quadrant(t[e], t[e + 1]), i = e + 1;
            i < t.length && Be.quadrant(t[i - 1], t[i]) === n;
        ...
        ($n.prototype.computeIntersectsForChain = function() {
          if (4 === arguments.length) {
            ...
            var r = arguments[0],
              ...
              f = s.pts[u];
            if (o - r == 1 && u - a == 1)
              return l.addIntersections(this.e, r, s.e, a), null;
            if (
              (this.env1.init(h, c),
              this.env2.init(p, f),
            ...
            var g = Math.trunc((r + o) / 2),
              d = Math.trunc((a + u) / 2);
            r < g &&
              (a < d && this.computeIntersectsForChain(r, g, s, a, d, l),
              d < u && this.computeIntersectsForChain(r, g, s, d, u, l)),
              g < o &&
      ...
      (ti.prototype.getDepth = function(t, e) {
        ...
        (ti.prototype.add = function() {
          if (1 === arguments.length)
            ...
            var r = arguments[0],
              o = arguments[1];
            arguments[2] === S.INTERIOR && this._depth[r][o]++;
          }
        }),
      ...
      var ni = (function(t) {
          ...
          return (
            ...
            (e.prototype.addIntersection = function(t, e, n, i) {
              var r = new b(t.getIntersection(i)),
                o = e,
      ...
      (ii.prototype.setWorkingPrecisionModel = function(t) {
        ...
        (ii.depthDelta = function(t) {
          var e = t.getLocation(0, Ne.LEFT),
            n = t.getLocation(0, Ne.RIGHT);
          return e === S.INTERIOR && n === S.EXTERIOR
            ? 1
            : e === S.EXTERIOR && n === S.INTERIOR ? -1 : 0;
        }),
      ...
      (ri.prototype.rescale = function() {
        ...
        (ri.prototype.scale = function() {
          if (O(arguments[0], Et)) {
            for (
              var t = arguments[0], e = new xt(), n = t.iterator();
              n.hasNext();
      ...
      (oi.prototype.checkEndPtVertexIntersections = function() {
        ...
        (oi.prototype.checkInteriorIntersections = function() {
          if (0 === arguments.length)
            ...
            if (
              (this._li.computeIntersection(g, d, _, y),
              this._li.hasIntersection() &&
                (this._li.isProper() ||
                  this.hasInteriorIntersection(this._li, g, d) ||
                  this.hasInteriorIntersection(this._li, _, y)))
            )
              throw new $(
      ...
      var ai = function() {
          ...
          1 !== e &&
            ((this._pt = new b(this.scale(t.x), this.scale(t.y))),
            (this._p0Scaled = new b()),
            (this._p1Scaled = new b())),
      ...
      (ai.prototype.intersectsScaled = function(t, e) {
        ...
        (ai.prototype.initCorners = function(t) {
          (this._minx = t.x - 0.5),
            ...
            (this._miny = t.y - 0.5),
            (this._maxy = t.y + 0.5),
            (this._corner[0] = new b(this._maxx, this._maxy)),
            (this._corner[1] = new b(this._minx, this._maxy)),
            (this._corner[2] = new b(this._minx, this._miny)),
            (this._corner[3] = new b(this._maxx, this._miny));
        }),
      ...
      var hi = function() {
        ...
        ci = { HotPixelSnapAction: { configurable: !0 } };
      ...
      var yi = function() {
        (this._pt = [new b(), new b()]),
          (this._distance = v.NaN),
          (this._isNull = !0);
      };
        ...
        (mi.computeDistance = function() {
          if (
            ...
            for (var h = 0; h < a.getNumInteriorRing(); h++)
              mi.computeDistance(a.getInteriorRingN(h), u, l);
          } else if (
            arguments[2] instanceof yi &&
            arguments[0] instanceof ht &&
            arguments[1] instanceof b
      ...
      var Ii = function(t) {
        (this._maxPtDist = new yi()),
          (this._minPtDist = new yi()),
          (this._geom = t || null);
      };
      (Ii.prototype.filter = function(t) {
        this._minPtDist.initialize(),
          mi.computeDistance(this._geom, t, this._minPtDist),
      ...
      (Li.prototype.filter = function(t, e) {
        ...
        var n = t.getCoordinate(e - 1),
          i = t.getCoordinate(e),
          r = new b((n.x + i.x) / 2, (n.y + i.y) / 2);
        this._minPtDist.initialize(),
          mi.computeDistance(this._geom, r, this._minPtDist),
          this._maxPtDist.setMaximum(this._minPtDist);
      }),
        ...
        (xi.getPolygons = function() {
          ...
          if (2 === arguments.length) {
            ...
            return (
              e instanceof $t
                ? n.add(e)
                : e instanceof Vt && e.apply(new xi(n)),
              n
            );
          }
        });
      ...
      (bi.prototype.filter = function(t) {
        ...
        (bi.prototype.setForceToLineString = function(t) {
        ...
        (bi.getGeometry = function() {
          if (1 === arguments.length) {
            var t = arguments[0];
            return t.getFactory().buildGeometry(bi.getLines(t));
          }
          if (2 === arguments.length) {
            var e = arguments[0],
              n = arguments[1];
            return e.getFactory().buildGeometry(bi.getLines(e, n));
          }
        }),
        (bi.getLines = function() {
          if (1 === arguments.length) {
            var t = arguments[0];
            return bi.getLines(t, !1);
          }
          if (2 === arguments.length) {
            ...
            if (
              ...
              var o = arguments[0],
                s = arguments[1],
                a = new xt();
              return o.apply(new bi(a, s)), a;
            }
            if (arguments[0] instanceof ht && O(arguments[1], Et)) {
              var u = arguments[0],
                l = arguments[1];
              return u instanceof Jt ? l.add(u) : u.apply(new bi(l)), l;
            }
          } else if (3 === arguments.length) {
            if (
              "boolean" == typeof arguments[2] &&
            ...
            if (
              ...
              var d = arguments[0],
                _ = arguments[1],
                y = arguments[2];
              return d.apply(new bi(_, y)), _;
            }
          }
        });
      var Ni = function() {
        if (
          ((this._boundaryRule = gt.OGC_SFS_BOUNDARY_RULE),
          (this._isIn = null),
      ...
      (Ni.prototype.locateInternal = function() {
        if (arguments[0] instanceof b && arguments[1] instanceof $t) {
          var t = arguments[0],
            e = arguments[1];
        ...
        if (arguments[0] instanceof b && arguments[1] instanceof Jt) {
          var a = arguments[0],
            u = arguments[1];
          if (!u.getEnvelopeInternal().intersects(a)) return S.EXTERIOR;
          var l = u.getCoordinates();
          return u.isClosed() || (!a.equals(l[0]) && !a.equals(l[l.length - 1]))
            ? at.isOnLine(a, l) ? S.INTERIOR : S.EXTERIOR
            : S.BOUNDARY;
        }
        if (arguments[0] instanceof b && arguments[1] instanceof Zt) {
          var h = arguments[0];
        ...
        (Ni.prototype.locateInPolygonRing = function(t, e) {
          return e.getEnvelopeInternal().intersects(t)
            ? at.locatePointInRing(t, e.getCoordinates())
            : S.EXTERIOR;
        }),
        (Ni.prototype.intersects = function(t, e) {
          return this.locate(t, e) !== S.EXTERIOR;
        }),
        (Ni.prototype.updateLocationInfo = function(t) {
          t === S.INTERIOR && (this._isIn = !0),
            t === S.BOUNDARY && this._numBoundaries++;
        }),
        (Ni.prototype.computeLocation = function(t, e) {
          if (
            (e instanceof Zt &&
        ...
        (Ni.prototype.locate = function(t, e) {
          return e.isEmpty()
            ? S.EXTERIOR
            : e instanceof Jt
        ...
        (Si.getPoints = function() {
          ...
          if (2 === arguments.length) {
            ...
            return (
              e instanceof Zt
                ? n.add(e)
                : e instanceof Vt && e.apply(new Si(n)),
              n
            );
          }
        });
      ...
      (Mi.prototype.filter = function(t) {
        (t instanceof Zt || t instanceof Jt || t instanceof $t) &&
      ...
      var Oi = function() {
        if (
          ...
          (this._ptLocator = new Ni()),
          (this._minDistanceLocation = null),
          (this._minDistance = v.MAX_VALUE),
          2 === arguments.length)
        ) {
          var t = arguments[0],
            e = arguments[1];
      ...
      (Oi.prototype.computeContainmentDistance = function() {
        if (0 === arguments.length) {
          ...
          if (
            ...
            for (
              var s = arguments[0], a = arguments[1], u = arguments[2], l = 0;
              l < s.size();
              l++
            )
              for (var h = s.get(l), c = 0; c < a.size(); c++)
                if (
                  (this.computeContainmentDistance(h, a.get(c), u),
                  this._minDistance <= this._terminateDistance)
                )
                  return null;
          } else if (
            ...
            var p = arguments[0],
              ...
              g = arguments[2],
              d = p.getCoordinate();
            if (S.EXTERIOR !== this._ptLocator.locate(d, f))
              return (
                (this._minDistance = 0), (g[0] = p), (g[1] = new Ci(f, d)), null
              );
          }
      }),
        ...
        (Oi.prototype.computeFacetDistance = function() {
          var t = new Array(2).fill(null),
            e = bi.getLines(this._geom[0]),
            n = bi.getLines(this._geom[1]),
            i = Si.getPoints(this._geom[0]),
            r = Si.getPoints(this._geom[1]);
          return (
          ...
          if (0 === arguments.length) {
            ...
            if (
              ...
              var u = arguments[0],
                ...
                h = arguments[2];
              if (
                u.getEnvelopeInternal().distance(l.getEnvelopeInternal()) >
                this._minDistance
              )
                return null;
              for (
                var c = u.getCoordinates(), p = l.getCoordinates(), f = 0;
                f < c.length - 1;
                f++
              )
      ...
      (Pi.prototype.interfaces_ = function() {
        ...
        (Pi.computeDistance = function() {
          if (
            ...
            for (var h = 0; h < a.getNumInteriorRing(); h++)
              Pi.computeDistance(a.getInteriorRingN(h), u, l);
          } else if (
            arguments[2] instanceof Ti &&
            arguments[0] instanceof ht &&
            arguments[1] instanceof b
      ...
      var Ai = function() {
        (this._maxPtDist = new Ti()),
          (this._minPtDist = new Ti()),
          (this._euclideanDist = new Pi()),
          (this._geom = null);
        var t = arguments[0];
        this._geom = t;
      };
      (Ai.prototype.filter = function(t) {
        this._minPtDist.initialize(),
          Pi.computeDistance(this._geom, t, this._minPtDist),
          this._maxPtDist.setMaximum(this._minPtDist);
      }),
      ...
      (ki.prototype.filter = function(t, e) {
        ...
        for (
          ...
          var a = n.x + s * r,
            ...
            l = new b(a, u);
          this._minPtDist.initialize(),
            Pi.computeDistance(this._geom, l, this._minPtDist),
            this._maxPtDist.setMaximum(this._minPtDist);
        }
      }),
      ...
      (Fi.prototype.checkMaximumDistance = function(t, e, n) {
        ...
        (Fi.prototype.getPolygonLines = function(t) {
          for (
            var e = new xt(), n = new bi(e), i = xi.getPolygons(t).iterator();
            i.hasNext();
      ...
      (Ui.prototype.getCoordinates = function() {
        ...
        (Ui.prototype.getSegmentOctant = function(t) {
          return t === this._pts.length - 1
            ? -1
            : cn.octant(this.getCoordinate(t), this.getCoordinate(t + 1));
        }),
      ...
      var Yi = function() {
        (this._op = null),
          ...
          (this._lineEdgesList = new xt()),
          (this._resultLineList = new xt());
        var t = arguments[0],
          e = arguments[1],
          n = arguments[2];
      ...
      (Wi.prototype.transformPoint = function(t, e) {
        ...
        (Wi.prototype.transformGeometryCollection = function(t, e) {
          ...
          return this._preserveGeometryCollectionType
            ? this._factory.createGeometryCollection(ye.toGeometryArray(n))
      ...
      (Ji.prototype.snapVertices = function(t, e) {
        for (
          ...
          null !== o &&
            (t.set(i, new b(o)),
            0 === i && this._isClosed && t.set(t.size() - 1, new b(o)));
        }
      }),
      ...
      var Ki = function(t) {
        ...
        Zi = { SNAP_PRECISION_FACTOR: { configurable: !0 } };
      (Ki.prototype.snapTo = function(t, e) {
        ...
        (Ki.computeOverlaySnapTolerance = function() {
          ...
          if (2 === arguments.length) {
            var r = arguments[0],
              o = arguments[1];
            return Math.min(
              Ki.computeOverlaySnapTolerance(r),
              Ki.computeOverlaySnapTolerance(o)
            );
          }
        }),
        (Ki.computeSizeBasedSnapTolerance = function(t) {
          ...
          return (
            Math.min(e.getHeight(), e.getWidth()) * Ki.SNAP_PRECISION_FACTOR
          );
        }),
      ...
      (rr.prototype.selfSnap = function(t) {
        ...
        (rr.prototype.computeSnapTolerance = function() {
          this._snapTolerance = Ki.computeOverlaySnapTolerance(
            this._geom[0],
            this._geom[1]
          );
        }),
          ...
          return this._xValue < e._xValue
            ...
            : this._xValue > e._xValue
              ...
              : this._eventType < e._eventType
                ? -1
                : this._eventType > e._eventType ? 1 : 0;
        }),
      ...
      (pr.prototype.getMin = function() {
        ...
        (pr.prototype.toString = function() {
          return Q.toLineString(new b(this._min, 0), new b(this._max, 0));
        }),
      ...
      (yr.prototype.buildTree = function() {
        ...
        (yr.prototype.printNode = function(t) {
          j.out.println(
            Q.toLineString(
              new b(t._min, this._level),
              new b(t._max, this._level)
            )
          );
        }),
      ...
      (Lr.prototype.init = function(t) {
        for (var e = bi.getLines(t).iterator(); e.hasNext(); ) {
          ...
          return (
            ...
            (e.prototype.insertBoundaryPoint = function(t, n) {
              var i = this._nodes.addNode(n).getLabel(),
                r = 1;
              S.NONE, i.getLocation(t, Ne.ON) === S.BOUNDARY && r++;
            ...
            (e.prototype.addEdge = function(t) {
              this.insertEdge(t);
              var e = t.getCoordinates();
              this.insertPoint(this._argIndex, e[0], S.BOUNDARY),
                this.insertPoint(this._argIndex, e[e.length - 1], S.BOUNDARY);
            }),
            (e.prototype.addLineString = function(t) {
              ...
              var n = new ni(e, new Pe(this._argIndex, S.INTERIOR));
            ...
            (e.prototype.addSelfIntersectionNode = function(t, e, n) {
              ...
              n === S.BOUNDARY && this._useBoundaryDeterminationRule
            ...
            (e.prototype.addPolygonRing = function(t, e, n) {
              ...
              var r = e,
                o = n;
              at.isCCW(i) && ((r = n), (o = e));
              var s = new ni(i, new Pe(this._argIndex, S.BOUNDARY, r, o));
              this._lineEdgeMap.put(t, s),
                this.insertEdge(s),
                this.insertPoint(this._argIndex, i[0], S.BOUNDARY);
            }),
            ...
            (e.prototype.locate = function(t) {
              return O(this._parentGeom, Qt) &&
                this._parentGeom.getNumGeometries() > 50
                ? (null === this._areaPtLocator &&
                    (this._areaPtLocator = new vr(this._parentGeom)),
        ...
        br = function() {
          if (
            ...
            e.getPrecisionModel().compareTo(n.getPrecisionModel()) >= 0
              ...
              (this._arg[0] = new xr(0, e, i)),
              (this._arg[1] = new xr(1, n, i));
          } else if (3 === arguments.length) {
            var r = arguments[0],
              o = arguments[1],
              s = arguments[2];
            r.getPrecisionModel().compareTo(o.getPrecisionModel()) >= 0
              ...
              (this._arg = new Array(2).fill(null)),
              (this._arg[0] = new xr(0, r, s)),
              (this._arg[1] = new xr(1, o, s));
          }
        };
      (br.prototype.getArgGeometry = function(t) {
        return this._arg[t].getGeometry();
      }),
        (br.prototype.setComputationPrecision = function(t) {
      ...
      (Nr.prototype.interfaces_ = function() {
        ...
        (Nr.map = function() {
          if (arguments[0] instanceof ht && O(arguments[1], Nr.MapOp)) {
            for (
              var t = arguments[0], e = arguments[1], n = new xt(), i = 0;
          ...
          if (O(arguments[0], Et) && O(arguments[1], Nr.MapOp)) {
            for (
              var o = arguments[0],
                s = arguments[1],
                a = new xt(),
      ...
      var Cr = (function(t) {
        ...
        return (
          ...
          (e.prototype.replaceCollapsedEdges = function() {
            for (
              var t = new xt(), e = this._edgeList.iterator();
              e.hasNext();
          ...
          (e.prototype.computeOverlay = function(t) {
            ...
            this._arg[0].computeSplitEdges(e),
              ...
              ji.checkValid(this._edgeList.getEdges()),
              this._graph.addEdges(this._edgeList.getEdges()),
          ...
          (e.prototype.findResultAreaEdges = function(t) {
            for (var n = this._graph.getEdgeEnds().iterator(); n.hasNext(); ) {
              ...
              r.isArea() &&
                ...
                e.isResultOfOp(
                  r.getLocation(0, Ne.RIGHT),
                  r.getLocation(1, Ne.RIGHT),
                  t
                ) &&
                i.setInResult(!0);
            }
                  ...
                  n.isNull(r) ||
                    ...
                    (0 === i.getDelta(r)
                      ...
                      : (et.isTrue(
                        ...
                        n.setLocation(r, Ne.LEFT, i.getLocation(r, Ne.LEFT)),
                        et.isTrue(
                          !i.isNull(r, Ne.RIGHT),
      ...
      (Sr.prototype.getLinework = function() {
      ...
      (Mr.prototype.extractPoints = function(t, e, n) {
        ...
        (Mr.prototype.getPoints = function(t) {
          for (
            var e = new xt(), n = bi.getLines(this._g).iterator();
            n.hasNext();
      ...
      var Or = function to() {
          (this._geom = null),
            ...
            (this._boundaryDistanceTolerance = to.TOLERANCE),
            (this._testCoords = new xt());
          var t = arguments[0],
            e = arguments[1],
            n = arguments[2];
          (this._boundaryDistanceTolerance = to.computeBoundaryDistanceTolerance(
            t,
            e
          )),
            (this._geom = [t, e, n]),
            (this._locFinder = [
              new wr(this._geom[0], this._boundaryDistanceTolerance),
              new wr(this._geom[1], this._boundaryDistanceTolerance),
              new wr(this._geom[2], this._boundaryDistanceTolerance)
            ]);
        },
        Tr = { TOLERANCE: { configurable: !0 } };
      (Or.prototype.reportResult = function(t, e, n) {
        j.out.println(
          "Overlay result invalid - A:" +
            S.toLocationSymbol(e[0]) +
            " B:" +
            S.toLocationSymbol(e[1]) +
            " expected:" +
            (n ? "i" : "e") +
            " actual:" +
            S.toLocationSymbol(e[2])
        );
      }),
        ...
        (Or.prototype.checkValid = function() {
          ...
          if (2 === arguments.length) {
            ...
            return (
              ...
              !!Or.hasLocation(this._location, S.BOUNDARY) ||
        ...
        (Or.computeBoundaryDistanceTolerance = function(t, e) {
          return Math.min(
            Ki.computeSizeBasedSnapTolerance(t),
            Ki.computeSizeBasedSnapTolerance(e)
          );
        }),
      ...
      var Pr = function eo(t) {
        (this._geomFactory = null),
          ...
          (this._geomFactory = eo.extractFactory(t)),
          (this._inputGeoms = t);
      };
      (Pr.prototype.extractElements = function(t, e) {
        ...
        (Pr.prototype.combine = function() {
          for (
            var t = new xt(), e = this._inputGeoms.iterator();
            e.hasNext();
      ...
      var Rr = function() {
          ...
          var t = arguments[0];
          (this._inputPolys = t),
            null === this._inputPolys && (this._inputPolys = new xt());
        },
        Dr = { STRTREE_NODE_CAPACITY: { configurable: !0 } };
      (Rr.prototype.reduceToGeometries = function(t) {
        for (var e = new xt(), n = t.iterator(); n.hasNext(); ) {
          var i = n.next(),
            r = null;
          O(i, Lt) ? (r = this.unionTree(i)) : i instanceof ht && (r = i),
            e.add(r);
        }
        return e;
      }),
        ...
        (Rr.prototype.union = function() {
          ...
          this._geomFactory = this._inputPolys
            ...
            .getFactory();
          for (
            var t = new sn(Rr.STRTREE_NODE_CAPACITY),
        ...
        (Rr.prototype.unionSafe = function(t, e) {
          return null === t && null === e
            ...
            : null === t
              ? e.copy()
              : null === e ? t.copy() : this.unionOptimized(t, e);
        }),
        ...
        (Rr.restrictToPolygons = function(t) {
          ...
          return 1 === e.size()
            ? e.get(0)
            : t.getFactory().createMultiPolygon(ye.toPolygonArray(e));
        }),
      ...
      if (h > 2) {
        for (a = 0; a < h; a++)
          a === h - 2
            ...
            (e = t[i]),
            (n = t[r]),
            (l += (s(t[o][0]) - s(e[0])) * Math.sin(s(n[1])));
        l = l * u * u / 2;
      }
      return l;
    }
        ...
        var e,
          ...
          r = function(t) {
            return t.map(function(t) {
              return { lat: t.lat + i.lat, lng: t.lng + i.lng };
            });
          };
        (e = this.isPolygon()
          ? this._layer._latlngs.map(r, this)
          : r(this._layer._latlngs)),
          this._layer.setLatLngs(e).redraw(),
          (this._tempDragCoord = n),
    ...
    o["default"].Line = o["default"].extend({
      ...
      enable: function(t) {
        L.Util.setOptions(this, t),
          ...
          this._map &&
            ...
            this.options.draggable && this._initDraggableLayer(),
      ...
      _handleLayerStyle: function(t) {
        ...
        if (this.hasSelfIntersection()) {
          ...
          t
            ? (L.DomUtil.addClass(e, "leaflet-pm-invalid"),
              window.setTimeout(function() {
                L.DomUtil.removeClass(e, "leaflet-pm-invalid");
              }, 200))
            : L.DomUtil.addClass(e, "leaflet-pm-invalid"),
        ...
        var i = function(e) {
          ...
          return (
            e.map(function(i, r) {
              var o;
              return (
                (o = t.isPolygon() ? (r + 1) % e.length : r + 1),
                t._createMiddleMarker(n[r], n[o])
              );
            }),
            n
          );
      ...
      _removeMarker: function(t) {
        ...
        if (!(-1 === this.findMarkerIndex(this._markers, n).index)) {
          ...
          if (
            (this.isPolygon()
              ? ((l = (s + 1) % u.length),
                (h = (s + (u.length - 1)) % u.length))
              : ((h = s - 1 < 0 ? undefined : s - 1),
                (l = s + 1 >= u.length ? undefined : s + 1)),
            l !== h)
          ) {
            var c = u[h],
              p = u[l];
      ...
      updatePolygonCoordsFromMarkerDrag: function(t) {
        var e = this._layer.getLatLngs(),
          ...
          i = n.ringIndex,
          r = n.index;
        (i > -1 ? e[i] : e).splice(r, 1, t.getLatLng()),
          this._layer.setLatLngs(e).redraw();
      },
  ...
  function(t, e, n) {
    ...
    i["default"].Circle = i["default"].extend({
      ...
      _initMarkers: function() {
        var t = this._map;
        this._layerGroup && this._layerGroup.clearLayers(),
          (this._layerGroup = new L.LayerGroup()),
          t.addLayer(this._layerGroup);
      ...
      _createHintLine: function(t, e) {
        var n = t.getLatLng(),
          i = e.getLatLng();
        (this._hintline = L.polyline([n, i], this.options.hintlineStyle)),
          (this._hintline._pmTempLayer = !0),
          this._layerGroup.addLayer(this._hintline);
      },
      ...
      _createOuterMarker: function(t) {
        var e = this._createMarker(t);
        return (
          this.options.preventVertexEdit && e.dragging.disable(),
          e.on("move", this._resizeCircle, this),
          e
        );
      },
      _createMarker: function(t) {
